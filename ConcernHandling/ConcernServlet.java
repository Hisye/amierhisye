    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Concern e : list) {
                ...
                out.print("<td>" + e.getConcern() + "</td>");
                out.print("<td><button onclick=\"highlightRow(this.parentNode.parentNode)\">Mark</button></td>");
                out.print("<td><button onclick=\"deleteRow('" + e.getId()+ "')\">Delete</button></td>");
                out.print("</tr>");
            }
            out.print("</table>");
