...
public class ViewStudentList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewStudentList</title>");            
            out.println("</head>");
            out.println("<body>");
        ...
        for (ViewStudentInfo e : list) {
            ...
            out.print("<td><a href='DeleteStudentList?name=" + e.getName()+ "'>Delete</a></td>");
            out.print("</tr>");
        }
            out.println("</body>");
            out.println("</html>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ViewStudentList.class.getName()).log(Level.SEVERE, null, ex);
