            ...
            <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="text-align: center; ">
                        <li class="nav-item">
                            <a class="nav-link" href="#">
                                <img src="logo2.png" alt="UMT Financial Aid System Logo">
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="viewStudentList.jsp">Student List</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="financialAidRegistration.jsp">Financial Aid</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Awarding.jsp">Application List</a>
                        </li><li class="nav-item">
                            <a class="nav-link" href="viewconcerns.jsp">Concern</a>
                        </li>
                    </ul>
                    <!-- Left links -->
                </div>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a id="logout-link" class="nav-link logout-button" href="index.jsp">
                                <button type='submit' class='btn btn-primary form' id='logout' style="background-color: #3D3D3D;">Logout</button>
                            </a>
                        </li>
                    </ul>
                </div>
